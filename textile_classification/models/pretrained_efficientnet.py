...
class PretrainedEfficientNet(nn.Module):
    ...
    the checkpoint of pretrained model already donwloaded from https://download.pytorch.org/models/efficientnet_v2_s-dd5fe13b.pth
    ...
    You can find more details about it on https://arxiv.org/abs/2104.00298
    ...
    def get_original_model(self) -> nn.Module:
        ...
        and create the efficientnet_v2_s model by load its pth file in that directory. 
        ...
        original_model = torch.hub.load(HUB_DIR_PRETRAINED, "efficientnet_v2_s", 
                                        source='local', weights="EfficientNet_V2_S_Weights.DEFAULT")
    ...
    def change_fc_layer(self, new_in_featues: int, new_out_features: int) -> None:
        ...
        new_classifier = nn.Sequential(
            ...
            nn.Linear(in_features=new_in_featues, out_features=new_out_features))
